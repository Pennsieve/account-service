...
import (
	...
	interactiveHandler "github.com/pennsieve/account-service/internal/handler/interactive"
...
func AccountServiceHandler(ctx context.Context, request events.APIGatewayV2HTTPRequest) (events.APIGatewayV2HTTPResponse, error) {
	...
	// Interactive-session public JWKS (must be UNAUTHENTICATED in the gateway).
	router.GET("/interactive/jwks", interactiveHandler.GetJWKSHandler)

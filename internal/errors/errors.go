...
var ErrComputeNotEnabledForWorkspace = errors.New("compute is not enabled for this workspace on this account")
var ErrStorageNotEnabledForWorkspace = errors.New("storage is not enabled for this workspace on this account")
